 ...
 *
 * Un seul chemin en produit : le rétablissement d'un instantané pris avant qu'on y range les
 * vecteurs. Appelé avant chaque recalcul d'ensemble et après un rétablissement ; s'il échoue —
...
export function recompute(id: number): Membership | null {
  ...
  /* Un mot sans vecteur n'y aurait rien apporté : ses posts sortiraient sans que personne l'ait
     ...
     vecteurs, et le recalcul qui suit chaque synchronisation la vidait. On garde donc
