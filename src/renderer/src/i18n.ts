...
const fr = {
  ...
  'organizer.stepAnalyse': 'Analyse localement le contenu disponible et les vignettes',
  'organizer.stepReview': 'Vous laisse renommer, fusionner ou exclure chaque catégorie',
  'organizer.stepApply': 'Ne crée les collections qu’après votre validation',
  ...
  'organizer.mapHint': 'Glissez pour déplacer · molette pour zoomer · Maj + glisser pour entourer un groupe',
  'organizer.mapTab': 'Carte',
  'organizer.listTab': 'Liste',
...
const en: Record<TranslationKey, string> = {
  ...
  'organizer.stepAnalyse': 'Locally analyses available content and thumbnails',
  'organizer.stepReview': 'Lets you rename, merge or exclude every category',
  'organizer.stepApply': 'Creates collections only after your approval',
  ...
  'organizer.mapHint': 'Drag to pan · scroll to zoom · Shift-drag to lasso a group',
  'organizer.mapTab': 'Map',
  'organizer.listTab': 'List',
