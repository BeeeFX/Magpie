...
const fr = {
  ...
  'downloads.thumbsName': 'Images d’aperçu',
  'downloads.thumbsHint': 'Les images du mur, en petit. C’est ce qui fait qu’une tuile s’affiche au lieu de rester grise.',
  'downloads.clipsName': 'Vidéos entières',
  'downloads.clipsHint': 'Les vidéos en entier, pour qu’elles démarrent aussitôt et se lisent hors connexion.',
  ...
  'downloads.kind.thumbnails': 'Images d’aperçu',
  'downloads.kind.clips': 'Vidéos',
...
const en: Record<TranslationKey, string> = {
  ...
  'downloads.thumbsName': 'Preview images',
  'downloads.thumbsHint': 'The small pictures in the wall. They are what makes a tile show up instead of staying grey.',
  'downloads.clipsName': 'Full videos',
  'downloads.clipsHint': 'Whole videos, so they start at once and play with no connection.',
  'downloads.amount': '{count} · {size}',
  ...
  'downloads.kind.thumbnails': 'Preview images',
  'downloads.kind.clips': 'Full videos',
