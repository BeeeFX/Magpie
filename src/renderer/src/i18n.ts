...
const fr = {
  ...
  'organizer.mapHint': 'Tirez un point pour l’étirer · molette pour zoomer et voir les liens · Maj + glisser pour entourer un groupe',
...
const en: Record<TranslationKey, string> = {
  ...
  'organizer.mapHint': 'Pull a point to stretch it · scroll to zoom and reveal links · Shift-drag to lasso a group',
