...
const fr = {
  ...
  'map.placeLabelArmed': 'Cliquez sur la carte…',
  'map.placeLabelHint': 'Cliquez un endroit pour le nommer, une étiquette pour la retirer. Échap pour sortir.',
...
const en: Record<TranslationKey, string> = {
  ...
  'map.placeLabelArmed': 'Click the map…',
  'map.placeLabelHint': 'Click a spot to name it, a label to remove it. Esc to leave.',
