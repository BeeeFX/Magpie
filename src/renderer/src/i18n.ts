...
const fr = {
  ...
  'grid.emptyArchived': 'Rien n’a été retiré de la bibliothèque.',
  ...
  'detail.archive': 'Retirer de la bibliothèque',
  'detail.archiveYes': 'Retirer ce post',
  'detail.restore': 'Remettre dans la bibliothèque',
  'detail.filterTag': 'Filtrer le mur sur « {name} »',
  'detail.removeTagOf': 'Retirer le tag « {name} »',
  ...
  'settings.moveLibraryYes': 'Choisir un dossier — Magpie redémarrera',
  ...
  'organizer.edgeRegenerateYes': 'Recalculer — environ 30 s',
  ...
  'organizer.keepGo': 'Continuer',
  'organizer.keepAll': 'Tout garder et continuer',
  'organizer.keepConfirm': 'Supprimer {count} collection|Supprimer {count} collections',
  ...
  'settings.models': 'Modèles d’analyse · {size}',
  'settings.modelsUnused': '{size} d’anciens modèles que plus rien n’utilise',
  'settings.pruneModels': 'Purger les anciens',
  'settings.pruneModelsYes': 'Supprimer les modèles inutilisés',
  'settings.pruning': 'Purge…',
  ...
  'settings.libraryMove.models': 'Copie des modèles d’analyse…',
  ...
  'notice.modelsPruned': '{size} libérés',
  'notice.collectionsRemoved': '{count} collection supprimée|{count} collections supprimées',
  'notice.mapFailed': 'La carte n’a pas pu être regénérée.',
  'notice.mapRoomsFailed': 'Les collections de la carte n’ont pas pu être lues.',
  'notice.mapLabelsFailed': 'Les noms posés sur la carte n’ont pas pu être lus.',
  'notice.mapFilterFailed': 'Le filtre n’a pas pu être appliqué : la carte montre tout.',
  'notice.mapLabelSaveFailed': 'Ce nom n’a pas pu être enregistré.',
  'notice.mapLabelRemoveFailed': 'Ce nom n’a pas pu être retiré.',
  'notice.collectionsRestored': '{count} collection rétablie|{count} collections rétablies',
  'notice.undo': 'Annuler',
  'notice.archiveFailed': 'Ce post n’a pas pu être retiré.',
  'notice.restore': 'Rétablir',
  'notice.modelsPruneFailed': 'Les anciens modèles n’ont pas pu être supprimés.',
  ...
  'bulk.archived': '{count} post retiré de la bibliothèque|{count} posts retirés de la bibliothèque',
  'bulk.restored': '{count} post remis dans la bibliothèque|{count} posts remis dans la bibliothèque',
  'bulk.archive': 'Retirer',
  'bulk.archiveYes': 'Retirer {count} post|Retirer {count} posts',
  'bulk.untagAsk': 'Retirer…',
  'bulk.untagYes': 'Retirer « {name} » de {count} post|Retirer « {name} » de {count} posts',
  ...
  'toolbar.savedBetween': 'Gardé entre',
  'toolbar.from': 'Du',
  'toolbar.to': 'Au',
...
const en: Record<TranslationKey, string> = {
  ...
  'grid.emptyArchived': 'Nothing has been removed from the library.',
  ...
  'detail.archive': 'Remove from the library',
  'detail.archiveYes': 'Remove this post',
  'detail.restore': 'Put back in the library',
  'detail.filterTag': 'Filter the wall on “{name}”',
  'detail.removeTagOf': 'Remove the tag “{name}”',
  ...
  'settings.moveLibraryYes': 'Pick a folder — Magpie will restart',
  ...
  'organizer.edgeRegenerateYes': 'Recompute — about 30 s',
  ...
  'organizer.keepGo': 'Continue',
  'organizer.keepAll': 'Keep everything and continue',
  'organizer.keepConfirm': 'Delete {count} collection|Delete {count} collections',
  ...
  'settings.models': 'Analysis models · {size}',
  'settings.modelsUnused': '{size} of older models nothing uses any more',
  'settings.pruneModels': 'Purge the old ones',
  'settings.pruneModelsYes': 'Delete the unused models',
  'settings.pruning': 'Purging…',
  ...
  'settings.libraryMove.models': 'Copying the analysis models…',
  ...
  'notice.modelsPruned': '{size} freed',
  'notice.collectionsRemoved': '{count} collection deleted|{count} collections deleted',
  'notice.mapFailed': 'The map could not be regenerated.',
  'notice.mapRoomsFailed': 'The map collections could not be read.',
  'notice.mapLabelsFailed': 'The names placed on the map could not be read.',
  'notice.mapFilterFailed': 'The filter could not be applied: the map shows everything.',
  'notice.mapLabelSaveFailed': 'That name could not be saved.',
  'notice.mapLabelRemoveFailed': 'That name could not be removed.',
  'notice.collectionsRestored': '{count} collection restored|{count} collections restored',
  'notice.undo': 'Undo',
  'notice.archiveFailed': 'That post could not be removed.',
  'notice.restore': 'Restore',
  'notice.modelsPruneFailed': 'The older models could not be deleted.',
  ...
  'bulk.archived': '{count} post removed from the library|{count} posts removed from the library',
  'bulk.restored': '{count} post put back in the library|{count} posts put back in the library',
  'bulk.archive': 'Remove',
  'bulk.archiveYes': 'Remove {count} post|Remove {count} posts',
  'bulk.untagAsk': 'Remove…',
  'bulk.untagYes': 'Remove “{name}” from {count} post|Remove “{name}” from {count} posts',
  ...
  'toolbar.savedBetween': 'Saved between',
  'toolbar.from': 'From',
  'toolbar.to': 'To',
