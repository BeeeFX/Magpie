...
const fr = {
  ...
  'organizer.recipeSujetSeul': 'Sujet seul',
  'organizer.recipeSujetSeulHint': 'Uniquement ce que l’image représente. Ni texte, ni style.',
  'organizer.recipeStructureSeule': 'Style seul',
  'organizer.recipeStructureSeuleHint': 'Uniquement l’allure : composition, palette, trait.',
  'organizer.recipeStructureHaute': 'Style dominant',
  'organizer.recipeStructureHauteHint': 'L’allure mène largement, le texte et le sujet restent en appoint.',
  'organizer.recipeTexte': 'Texte',
  'organizer.recipeTexteHint': 'Ce que disent la légende, les tags et l’auteur. Le comportement d’avant.',
  'organizer.recipeEquilibre': 'Équilibré',
  'organizer.recipeEquilibreHint': 'Le texte mène, l’image complète. Réglé à la mesure.',
  'organizer.recipeImage': 'Image',
  'organizer.recipeImageHint': 'Ce que le post montre prend la main ; le texte n’est qu’un appoint.',
  'organizer.recipeSujet': 'Sujet',
  'organizer.recipeSujetHint': 'Ce que l’image représente, sans tenir compte du style.',
  'organizer.recipeStyle': 'Style',
  'organizer.recipeStyleHint': 'Regroupe ce qui se ressemble, plutôt que ce qui parle du même sujet.',
...
const en: Record<TranslationKey, string> = {
  ...
  'organizer.recipeSujetSeul': 'Subject only',
  'organizer.recipeSujetSeulHint': 'Only what the image depicts. No text, no style.',
  'organizer.recipeStructureSeule': 'Style only',
  'organizer.recipeStructureSeuleHint': 'Only the look: composition, palette, line.',
  'organizer.recipeStructureHaute': 'Style-led',
  'organizer.recipeStructureHauteHint': 'The look leads by a wide margin; text and subject only assist.',
  'organizer.recipeTexte': 'Text',
  'organizer.recipeTexteHint': 'What the caption, tags and author say. The previous behaviour.',
  'organizer.recipeEquilibre': 'Balanced',
  'organizer.recipeEquilibreHint': 'Text leads, the image completes. Set by measurement.',
  'organizer.recipeImage': 'Image',
  'organizer.recipeImageHint': 'What the post shows takes over; text is only a hint.',
  'organizer.recipeSujet': 'Subject',
  'organizer.recipeSujetHint': 'What the image depicts, ignoring its style.',
  'organizer.recipeStyle': 'Style',
  'organizer.recipeStyleHint': 'Groups what looks alike, rather than what talks about the same thing.',
