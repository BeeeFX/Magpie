...
const fr = {
  ...
  'organizer.edgeSplitHint': 'Maj + glisser en travers d’une cellule : elle se scinde en deux.',
  'organizer.splitName': 'Détaché de {name} · {count}',
  'organizer.splitDescription': 'Posts détachés à la main sur la carte.',
  'organizer.edgeMergeHint': 'Alt ou clic droit sur une paroi : les deux collections n’en font plus qu’une.',
...
const en: Record<TranslationKey, string> = {
  ...
  'organizer.edgeSplitHint': 'Shift + drag across a cell: it splits in two.',
  'organizer.splitName': 'Split from {name} · {count}',
  'organizer.splitDescription': 'Posts split by hand on the map.',
  'organizer.edgeMergeHint': 'Alt or right-click a wall: the two collections become one.',
